 ...
 */
function widz_form_icon_picker( $settings, $value = '' ) {

	$attrs = array();

	$css_class = 'widz-field widz-icon_picker';
	...
	if ( !has_filter( 'widz_source_' . $source_font ) ) {
		$source_font = 'fontawesome';
	}

	$arr = apply_filters( 'widz_source_' . $source_font, array() );

	ob_start();
	?>
	<div class="<?php echo esc_attr( $css_class ) ?>">
		<select class="widz_value" <?php echo implode( ' ', $attrs ) ?>>
			<?php
			if ( !empty( $arr ) ) {
 ...
 */
function widz_source_fontawesome( $icons ) {
...
add_filter( 'widz_source_fontawesome', 'widz_source_fontawesome' );
