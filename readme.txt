...
No, Widz uses and extends the default WordPress methods and does not replace anything.

== Screenshots ==

1. How it showing in admin widget
2. You can select icon for the tab item
